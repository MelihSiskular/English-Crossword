...
var bulmacalar :[Bulmaca] = [
    ...
    Bulmaca(title: "Hava Durumu-1", image: UIImage(named: "Bulmaca 12")!, score: 0,  TurkishWordsArray: [
    ...
    Bulmaca(title: "Hava Durumu-2", image: UIImage(named: "Bulmaca 12")!, score: 0,  TurkishWordsArray: [
    ...
    Bulmaca(title: "Hava Durumu-3", image: UIImage(named: "Bulmaca 12")!, score: 0,  TurkishWordsArray: [
    ...
    Bulmaca(title: "Meslekler-2", image: UIImage(named: "Bulmaca 11")!, score: 0,  TurkishWordsArray: [
    ...
    Bulmaca(title: "Meslekler-3", image: UIImage(named: "Bulmaca 11")!, score: 0,  TurkishWordsArray: [
    ...
    Bulmaca(title: "Meslekler-4", image: UIImage(named: "Bulmaca 11")!, score: 0,  TurkishWordsArray: [
    ...
    Bulmaca(title: "Hayvanlar-1", image: UIImage(named: "Bulmaca 11")!, score: 0,  TurkishWordsArray: [
    ...
    Bulmaca(title: "Hayvanlar-2", image: UIImage(named: "Bulmaca 11")!, score: 0,  TurkishWordsArray: [
    ...
    Bulmaca(title: "Hayvanlar-3", image: UIImage(named: "Bulmaca 11")!, score: 0,  TurkishWordsArray: [
